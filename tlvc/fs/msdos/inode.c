...
struct msdos_devdir_entry devnods[DEVDIR_SIZE] = {
    ...
    { "hdb1",	S_IFBLK | 0644, MKDEV(5, 33) },
    { "hdb2",	S_IFBLK | 0644, MKDEV(5, 34) },
    { "hdb3",	S_IFBLK | 0644, MKDEV(5, 35) },
    { "hdb4",	S_IFBLK | 0644, MKDEV(5, 36) },
    { "rhdb",	S_IFCHR | 0644, MKDEV(5, 32)},
    { "rhdb1",	S_IFCHR | 0644, MKDEV(5, 33) },
    { "rhdb2",	S_IFCHR | 0644, MKDEV(5, 34) },
    { "rhdb3",	S_IFCHR | 0644, MKDEV(5, 35) },
    { "rhdb4",	S_IFCHR | 0644, MKDEV(5, 36) },
#endif
#ifdef CONFIG_BLK_DEV_BHD
    { "bda",	S_IFBLK | 0644, MKDEV(3, 0) },
    { "bda1",	S_IFBLK | 0644, MKDEV(3, 1) },
    { "bda2",	S_IFBLK | 0644, MKDEV(3, 2) },
    { "bda3",	S_IFBLK | 0644, MKDEV(3, 3) },
    { "bda4",	S_IFBLK | 0644, MKDEV(3, 4) },
    { "bdb",	S_IFBLK | 0644, MKDEV(3, 32)},
    { "bdb1",	S_IFBLK | 0644, MKDEV(3, 33)},
...
printk("FAT: me=%x,csz=%d,#f=%d,floc=%d,fsz=%d,rloc=%d,#d=%d,dloc=%d,#s=%ld,ts=%lu\n",
